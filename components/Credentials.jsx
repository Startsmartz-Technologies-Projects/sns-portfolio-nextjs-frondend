          ...
          <div className="cr-verify-grid">
            ...
            <aside
              ...
              <p className="cr-verify-foot">
                SNS Overseas holds Recruiting Licence RL-2567, issued by the Bureau
                of Manpower, Employment and Training (BMET) under the Ministry of
                Expatriates&apos; Welfare and Overseas Employment, Government of the
                People&apos;s Republic of Bangladesh.
              </p>

              <p className="cr-verify-foot">
                This licence authorises us to legally recruit and deploy Bangladeshi
                workers to overseas employers. You can verify our registration
                directly through BMET&apos;s public records or contact us for guidance.
              </p>
