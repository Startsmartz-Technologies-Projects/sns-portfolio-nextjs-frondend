    ...
    <>
      ...
      <section className="feature-band" data-screen-label="04 Training">
        ...
        <div className="container feature-band-grid">
          ...
          <figure className="facility-frame" aria-label="Training and testing centre">
            <div className="facility-inner">
              ...
              <img
                ...
                alt="SNS Overseas in-house training and trade testing facility"
        ...
        <div className="container">
          ...
          <div className="aud-grid">
            <AudienceCard
              ...
              body="Licensed sourcing, in house screening and tradetesting, and Migrants Act compliant paperwork so each deployment is predictable, traceable, and on-time."
              href="#"
